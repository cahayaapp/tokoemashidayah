...
Fitur foto produk dirombak total. Versi lama mencoba mengunggah foto ke Cloud Storage. Karena project Firebase pada paket Spark tidak dapat memakai Cloud Storage, foto gagal tersimpan. Versi 2.1.0 tidak bergantung pada Cloud Storage lagi.
...
## Pasang rules dan indeks Firebase v2.1.0
