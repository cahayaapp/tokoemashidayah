import { saveGoldRates, getGoldRates } from '../services/data-service.js?v=2.1.4';
import { state, canManage } from '../core/state.js?v=2.1.4';
import { KARATS, DEFAULT_GOLD_RATES } from '../core/constants.js?v=2.1.4';
import { formatRupiah, getErrorMessage } from '../core/utils.js?v=2.1.4';
import { pageLoading, toast, setButtonLoading } from '../core/ui.js?v=2.1.4';
