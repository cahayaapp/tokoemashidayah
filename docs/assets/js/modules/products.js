import { listProducts, saveProduct, removeProduct } from '../services/data-service.js?v=2.1.4';
import { PRODUCT_CATEGORIES, KARATS } from '../core/constants.js?v=2.1.4';
import { canManage } from '../core/state.js?v=2.1.4';
import { formatRupiah, formatNumber, normalizeText, compressImageForFirestore, downloadCSV, getErrorMessage, escapeHTML } from '../core/utils.js?v=2.1.4';
import { pageLoading, tableEmpty, badge, openModal, closeModal, confirmDialog, toast, setButtonLoading, attachCurrencyInput, getCurrencyValue } from '../core/ui.js?v=2.1.4';
