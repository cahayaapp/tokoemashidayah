import { getDashboardData } from '../services/data-service.js?v=2.1.2';
import { formatRupiah, formatNumber, sum, toDate } from '../core/utils.js?v=2.1.2';
import { renderStatCard, pageLoading, tableEmpty, badge } from '../core/ui.js?v=2.1.2';
