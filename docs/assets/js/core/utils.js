...
export function getErrorMessage(error) {
  ...
  const messages = {
    ...
    'auth/account-creation-failed': 'Akun pengguna gagal dibuat di Firebase Authentication.',
    'auth/configuration-not-found': 'Konfigurasi Firebase Authentication tidak cocok dengan project aplikasi.',
